...
<script>
	$(function(){
			...
			$("#user_tags_form button").click(function(e) {
           		...
           		if($('#user_tags_form .tt-input').val()!=''){
           			tags_typeahead.tagsinput('add', $('#user_tags_form .tt-input').val());
           		}
			...
			for(var i = 0; i < user_tags.length; i++){
				tags_typeahead.tagsinput('add', user_tags[i].name);
			}
